...
.. important:: Сегментированные кэши идеально подходят для работы с большими наборами данных и их частых обновлениях

Пример настройки режима кэширования *PARTITIONED* приведен в разделе `Конфигурация`_.
