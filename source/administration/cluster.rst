...
+ На добавляемом узле должны быть выполнены все настройки, описанные в разделе `Подготовка к установке Hadoop <http://docs.arenadata.io/adh/v1.4/install/prepare.html#id1>`_ документа `Инструкция по установке кластера <http://docs.arenadata.io/adh/v1.4/install/index.html#id1>`_;
