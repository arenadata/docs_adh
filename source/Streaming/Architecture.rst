...
Как и в большинстве распределенных систем для автоматической обработки сбоев требуется точное определение термина "живой" узел. Для такого узла **ADS** есть два условия:
