...
**Apache Zeppelin** обеспечивает несколько интерпретаторов, перечень которых представлен в разделе `Предоставляемые сообществом интерпретаторы`_. Для установки загруженного двоичного пакета *netinst* следует в зависимости от необходимых интерпретаторов выполнить соответствующие команды.
