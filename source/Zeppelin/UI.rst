...
В этом диалоговом окне вы можете (в порядке убывания):

+ найти идентификатор абзаца (20150924-163507_134879501)
+ ширина абзаца. Поскольку Цеппелин использует сетчатую систему Twitter Bootstrap, каждая ширина абзаца может быть изменена от 1 до 12
+ переместите уровень абзаца 1 вверх
+ переместите уровень абзаца 1 вниз
+ создать новый абзац
+ изменить заголовок пункта
+ показать / скрыть номер строки в разделе кода
+ отключить кнопку запуска для этого пункта
+ экспортируйте текущий абзац в качестве iframe и откройте iframe в новом окне
+ очистить раздел результатов
