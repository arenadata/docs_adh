...
В разделе "Подготовка к установке кластера" приведена информация и даны материалы, которые необходимо подготовить для установки кластера
...
.. list-table:: Минимальные системные требования для установки кластера Arenadata Ambari
   ...
   * - База данных
     - Ambari требует реляционную базу данных для хранения |br|
       ...
       «Настройка сервера Ambari 2.5.2»
